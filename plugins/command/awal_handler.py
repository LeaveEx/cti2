...
async def start_handler(client: Client, msg: types.Message):
    ...
    username = '@bshsusiai' if not msg.from_user.username else '@' + msg.from_user.username
...
async def help_handler(client, msg):
    ...
    pesan += '#imboy untuk segala menfess \n\nContoh :  \naku gabut banget tau #imboy \n#imboy aku gabut banget \nTetap patuhi rules ya! Jangan bandel! \n\n'
